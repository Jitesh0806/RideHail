...
# Public subnets — EC2 instances and ALB live here
...
# ─── NAT Gateway (lets private subnets reach internet for updates) ─────────────
...
# Public route table — routes all traffic through internet gateway
